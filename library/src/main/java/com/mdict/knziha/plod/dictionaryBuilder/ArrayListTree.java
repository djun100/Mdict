...
public class ArrayListTree<T extends Comparable<T>> {
	...
	com.mdict.knziha.rbtree.RBTree_duplicative.inOrderDo inOrderDo_;
	public void SetInOrderDo(com.mdict.knziha.rbtree.RBTree_duplicative.inOrderDo inOrderDo) {
