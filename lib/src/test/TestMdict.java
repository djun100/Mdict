...
public class TestMdict {
    ...
    //A keyword to search!			//简明英汉汉英词典.mdx      古生物图鉴.mdx
    	...
    	//UtilMy.show(md.getRecordAt(md.lookUp("龤")));
    	//md.printDictInfo();
    ...
    //A bunch of tests~
    	...
    	{	/* false  true  */ 
    		...
    		key = "abces";
	        //UtilMy.show("查询 "+key+" ： "+md.getEntryAt(md.lookUp(key)));
      ...
      //![3]fuzzy search ✔
	    ...
	    //	stst=System.currentTimeMillis();
	    //    md.findAllKeys(key);
	    //    UtilMy.show("模糊匹配 Contain:"+key+" time used： "+(System.currentTimeMillis()-stst)+"ms");
        //} 
        ...
        //m.printAllKeys();
    	//UtilMy.show(":::>"+m.getEntryAt(m.lookUp("\\pic\\wolfSnow.jpg")));
        ...
        //UtilMy.show(m.lookUp("a and")+"");
        
        //mdict m = new mdict("E:\\assets\\mdicts\\TCM_Textbook.mdx");
        //m.printAllKeys();
        //UtilMy.show(m.getEntryAt(m.lookUp("\\VMpix\\ShengWuPix\\shengwuhuaxueyufenzishengwuxue279.jpg"))+"");
        //UtilMy.show(m.getRecordAt(0)+"");
        //UtilMy.show((m.getEntryAt(m.lookUp("\hex111111.jpg")))+"");
        //UtilMy.show((m.getEntryAt(m.lookUp("目的")))+"");
